...
(function($) {
    ...
    $.extend(MediaElementPlayer.prototype, {
        ...
        buildplaylist: function(player, controls, layers, media) {
            var t = this;
            var playlistToggle = $('<div class="mejs-button mejs-playlist-button ' + (player.options.playlist ? "mejs-show-playlist" : "mejs-show-playlist") + '">' + '<button type="button" aria-controls="' + player.id + '" title="' + player.options.playlistText + '"></button>' + "</div>");
        ...
        playNextTrack: function() {
            var next = $(document).find('[rel="next"]').attr('href');
            this.redirect(next);
        },
        playPrevTrack: function() {
            var prev = $(document).find('[rel="prev"]').attr('href');
            this.redirect(prev);
        },
