            ...
            <div class="k-news col-md-8 col-sm-12 col-xs-12 col-lg-8 nopadding">
                ...
                <article class="k-news-item col-md-6 col-sm-6 col-xs-12 col-lg-6 ">
                    ...
                    <div class="k-b-itemdesc">
                        ...
                        <?php if (!empty($post_meta['reviewSupTitle'][0])): ?><p class="k-b-uptitle"><?php echo $post_meta['reviewSupTitle'][0]; ?></p><?php endif; ?>
                        <a href="<?php the_permalink(); ?>">
                            <h4 class="k-b-title"><?php the_title(); ?></h4>
                        </a>
                        <p class="k-b-intro"><?php the_excerpt(); ?></p>
                        <time class="k-time" datetime="<?php echo date('Y-m-d H:i:s', get_the_time('U')); ?>"><i class="fa fa-clock-o" aria-hidden="true"></i>  <?php echo human_time_diff( get_the_time('U'), current_time('timestamp') ) . ' ﬁ»·'; ?></time>
                        <a href="<?php the_permalink(); ?>" class="kbtn black">«œ«„Â Œ»—</a>
                    </div>
                </article>
                <?php
                    endwhile;
